...
internal readonly record struct ObjectPlacement<T, M>() where T : Transform where M : MonoBehaviour
{
...
internal readonly record struct ObjectPlacements<T, M> where T : Transform where M : MonoBehaviour
{
