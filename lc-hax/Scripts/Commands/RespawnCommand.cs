    ...
    public void RespawnLocalPlayer() // This is a modified version of StartOfRound.ReviveDeadPlayers
       {
        ...
        Helper.HUDManager.UpdateHealthUI(100, false);
        playerControllerB.spectatedPlayerScript = null;
        Helper.HUDManager.audioListenerLowPass.enabled = false;
        Helper.StartOfRound.SetSpectateCameraToGameOverMode(false, playerControllerB);
        Helper.StartOfRound.livingPlayers = Helper.StartOfRound.connectedPlayersAmount + 1;
        Helper.StartOfRound.allPlayersDead = false;
        Helper.StartOfRound.UpdatePlayerVoiceEffects();
        Helper.StartOfRound.shipAnimator.ResetTrigger("ShipLeave");
    }
