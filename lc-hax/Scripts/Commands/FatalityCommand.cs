...
public class FatalityCommand : ICommand {
    ...
    string? HandleGiant(PlayerControllerB targetPlayer) {
        ...
        forestGiant.GrabPlayerServerRpc(targetPlayer.ClientId());
        return null;
    }
    ...
    string? HandleJester(PlayerControllerB targetPlayer) {
        ...
        jester.KillPlayerServerRpc(targetPlayer.ClientId());
        return null;
    }
    ...
    string? HandleMasked(PlayerControllerB targetPlayer) {
        ...
        masked.KillPlayerAnimationServerRpc(targetPlayer.ClientId());
        return null;
    }
    ...
    string? HandleBaboonHawk(PlayerControllerB targetPlayer) {
        ...
        baboonHawk.StabPlayerDeathAnimServerRpc(targetPlayer.ClientId());
        return null;
    }
    ...
    string? HandleBees(PlayerControllerB targetPlayer) {
        ...
        bees.BeeKillPlayerServerRpc(targetPlayer.ClientId());
        return null;
    }
    ...
    string? HandleThumper(PlayerControllerB targetPlayer) {
        ...
        thumper.EatPlayerBodyServerRpc(targetPlayer.ClientId());
        return null;
    }
    ...
    string? HandleEyelessDog(PlayerControllerB targetPlayer) {
        ...
        eyelessDog.KillPlayerServerRpc(targetPlayer.ClientId());
        return null;
    }
    ...
    string? HandleBracken(PlayerControllerB targetPlayer) {
        ...
        bracken.KillPlayerAnimationServerRpc(targetPlayer.ClientId());
        return null;
    }
    ...
    string? HandleNutcracker(PlayerControllerB targetPlayer) {
        ...
        nutcracker.LegKickPlayerServerRpc(targetPlayer.ClientId());
        return null;
    }
