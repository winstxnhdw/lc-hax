...
namespace Hax
{
    internal static partial class Helper
    {
        ...
        /// <param name="controller">The controller. If none is given, it will use PossessionMod's and get a suitable controller to reset its searches.</param>
        ...
        /// <summary>
        /// Finds the closest player to the enemy within a specified radius, prioritizing players on the ground. Defaults to the Host if no player is found.
        /// </summary>
        /// <param name="enemy">The enemy AI.</param>
