static class TerminalItems {
    ...
    internal static bool isDoorOpen(this TerminalAccessibleObject door) =>
        door.Reflect().GetInternalField<bool>("isDoorOpen");
    ...
    internal static void Explode(this Landmine landmine) =>
    ...
    internal static bool isLandmineActive(this Landmine landmine) =>
        landmine.Reflect().GetInternalField<bool>("mineActivated");
    ...
    internal static void ToggleLandmine(this Landmine landmine, bool UseTerminalComponent = false) =>
        landmine?.SetLandmine(!landmine.isLandmineActive(), UseTerminalComponent);
    ...
    internal static void SetLandmine(this Landmine landmine, bool mineActivated, bool UseTerminalComponent = false) {
        ...
        if (UseTerminalComponent)
            if (landmine.TryGetComponent(out TerminalAccessibleObject terminal)) {
                if (!terminal.IsInCooldown()) terminal.CallFunctionFromTerminal();
    ...
    /// <param name="UseTerminalComponent">Indicates whether to use the terminal component if available.</param>
    internal static void ToggleTurret(this Turret turret, bool UseTerminalComponent = false) =>
        turret?.SetTurret(!turret.isTurretActive(), UseTerminalComponent);
    ...
    /// <param name="UseTerminalComponent">Indicates whether to use the terminal component if available.</param>
    internal static void ToggleSpikes(this SpikeRoofTrap spike, bool UseTerminalComponent = false) =>
        spike?.SetSpikes(!spike.isTrapActive(), UseTerminalComponent);
    ...
    internal static void SetInCooldown(this TerminalAccessibleObject obj, bool inCooldown) =>
        obj?.Reflect().SetInternalField("inCooldown", inCooldown);
    ...
    internal static bool IsInCooldown(this TerminalAccessibleObject obj) =>
        obj?.Reflect().GetInternalField<bool>("inCooldown") ?? false;
    ...
    /// <returns>
    ///     True if the spike trap is in cooldown; otherwise, false. Returns false if the object is null or doesn't have a
    ///     TerminalAccessibleObject component.
    /// </returns>
    internal static bool IsInCooldown(this SpikeRoofTrap spike) {
        if (spike.TryGetComponent(out TerminalAccessibleObject terminal)) return terminal.IsInCooldown();
    ...
    /// <returns>
    ///     True if the turret is in cooldown; otherwise, false. Returns false if the object is null or doesn't have a
    ///     TerminalAccessibleObject component.
    /// </returns>
    internal static bool IsInCooldown(this Turret turret) {
        if (turret.TryGetComponent(out TerminalAccessibleObject terminal)) return terminal.IsInCooldown();
    ...
    /// <returns>
    ///     True if the landmine is in cooldown; otherwise, false. Returns false if the object is null or doesn't have a
    ///     TerminalAccessibleObject component.
    /// </returns>
    internal static bool IsInCooldown(this Landmine landmine) {
        if (landmine.TryGetComponent(out TerminalAccessibleObject terminal)) return terminal.IsInCooldown();
