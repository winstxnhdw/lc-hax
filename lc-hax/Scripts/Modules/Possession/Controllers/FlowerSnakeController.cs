...
internal class FlowerSnakeController : IEnemyController<FlowerSnakeEnemy> {
    ...
    public Vector3 GetCameraOffset(FlowerSnakeEnemy enemy) {
        ...
        if (enemy.clingingToPlayer is null) { // Is Roaming
    ...
    bool IsClingingToSomething(FlowerSnakeEnemy enemy) => enemy.clingingToPlayer is not null || enemy.inSpecialAnimation;
