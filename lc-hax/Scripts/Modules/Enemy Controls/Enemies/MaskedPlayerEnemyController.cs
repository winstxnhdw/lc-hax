...
public static class MaskedPlayerController {
    ...
    public static void OnMoving(this MaskedPlayerEnemy instance, bool isRunning = false) {
        instance.SetRunningServerRpc(isRunning);
    }

    public static void UsePrimarySkill(this MaskedPlayerEnemy instance) {
        instance.SetHandsOut();
    }

    public static void SetHandsOut(this MaskedPlayerEnemy instance) {
        if (instance == null) return;
        instance.SetHandsOutServerRpc(!instance.creatureAnimator.GetBool("HandsOut"));
    }
